<script lang="ts">
    ...
    let messageList: {
        ...
        { senderName: "Admin", messageType: 1, message: "Welcome!" },
        {
            senderName: "User",
            messageType: 1,
            message:
                "This is a chat room for the tournament. You can chat with other players here.",
        },
        {
            senderName: "",
            messageType: 1,
            message: "dnoawijdnm awknd nawjlw da!",
        },
        { senderName: "Mari", messageType: 1, message: "kjn alwndl!" },
        {
            senderName: "ldmk",
            messageType: 1,
            message:
                "lwndl makwdl kawmnd lnawlmdm ka fl jakldfn jlnakfn aje fl nw fdka !",
        },
        {
            senderName: "ndwlakd",
            messageType: 1,
            message: " kjmawp mfçawmnf amç!",
        },
        { senderName: "d dw a", messageType: 1, message: "çlmf kamfp !" },
        {
            senderName: "ndwlakd",
            messageType: 1,
            message:
                "l amefkçm aknefkçm aeçkfn kçamçf nalmef çlafkdhwaodh wjoahdjh wjahdlhjahdoj jahdjo aedo jaedjoa keh oalhdjeafkj ehajk flal naçlfm akçen fkjnelkf aklnf klan elkfkla!",
        },
        { senderName: "kkmad", messageType: 1, message: " maçkfmpa mfçlame!" },
    ];
    let messageInput = "";
