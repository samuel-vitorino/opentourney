...
<div class="flex flex-col w-full shadow-md">
    <div class="box-content p-4">
        <div class="flex flex-row h-[250px]" id="tournamentBackground">
            <div class="w-full h-full flex flex-col justify-end bg-" id="tournamentOverlay">
                <div class="ml-5 mb-5">
                    <P size="xs" weight="extrabold" color="text-gray-300">FINISHED</P>
                    <P size="3xl" color="text-white" weight="semibold">IPL Lan Party</P>
                    <div class="flex">
                        <P color="text-gray-200" weight="medium" class="mr-1" size="sm">Organized by</P>
                        <P size="sm" weight="semibold" color="text-orange-300">IPLeiria</P>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="flex justify-between">
                            <div class="grow">
                                ...
                                <div class="flex ml-3 mb-4 justify-around">
                                    ...
                                    <div class="flex">
                                        <svg class="w-[50px] h-[50px]" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" baseProfile="full" enable-background="new 0 0 76.00 76.00" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#000000" fill-opacity="1" stroke-width="0.2" stroke-linejoin="round" d="M 23.75,60.1667L 23.75,53.8333L 31.6667,53.8333L 31.6666,47.5L 23.75,47.5L 23.75,41.1667L 38,41.1667L 38,47.5L 44.3333,47.5L 44.3333,28.5L 38,28.5L 38,34.8333L 23.75,34.8333L 23.75,28.5L 31.6667,28.5L 31.6666,22.1666L 23.75,22.1667L 23.75,15.8333L 38,15.8333L 38,22.1666L 50.6666,22.1667L 50.6666,34.8333L 58.5833,34.8333L 58.5833,41.1667L 50.6666,41.1667L 50.6666,53.8333L 38,53.8333L 38,60.1667L 23.75,60.1667 Z "></path> </g></svg>
                                        <div class="ml-3">
                                            <div>
                                                <P color="text-gray-500">Format</P>
                                                <P weight="bold">Single-Elimination</P>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <P>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ac tincidunt vitae semper quis lectus nulla. Lorem dolor sed viverra ipsum nunc aliquet bibendum enim facilisis. Ac ut consequat semper viverra nam libero justo. Mauris a diam maecenas sed enim ut. Aliquet lectus proin nibh nisl condimentum id. Scelerisque viverra mauris in aliquam sem fringilla ut. Pulvinar sapien et ligula ullamcorper malesuada proin libero nunc. Sed enim ut sem viverra aliquet eget sit amet tellus. Quis enim lobortis scelerisque fermentum dui faucibus in. Sed elementum tempus egestas sed sed risus pretium quam vulputate. Id nibh tortor id aliquet lectus proin.

                                    Ante in nibh mauris cursus mattis molestie a iaculis at. Pellentesque dignissim enim sit amet venenatis urna cursus eget. Lorem ipsum dolor sit amet consectetur adipiscing elit pellentesque habitant. Tempor nec feugiat nisl pretium fusce. Enim nulla aliquet porttitor lacus luctus. Adipiscing elit ut aliquam purus sit amet luctus. Nam aliquam sem et tortor consequat id porta nibh venenatis. Id velit ut tortor pretium viverra. Lectus proin nibh nisl condimentum id venenatis a condimentum. Mus mauris vitae ultricies leo integer. Quis ipsum suspendisse ultrices gravida dictum fusce ut placerat orci. Est ante in nibh mauris cursus mattis molestie a. Eu turpis egestas pretium aenean pharetra magna ac placerat vestibulum. Tellus in hac habitasse platea dictumst.

                                    Urna condimentum mattis pellentesque id nibh tortor. Mattis vulputate enim nulla aliquet porttitor lacus luctus accumsan. Elementum tempus egestas sed sed risus. Proin sagittis nisl rhoncus mattis rhoncus urna neque. Mauris vitae ultricies leo integer malesuada nunc. Diam maecenas ultricies mi eget mauris pharetra et ultrices neque. Eu mi bibendum neque egestas congue quisque egestas diam in. Pulvinar pellentesque habitant morbi tristique senectus. Volutpat ac tincidunt vitae semper quis lectus nulla at volutpat. In arcu cursus euismod quis viverra nibh cras pulvinar mattis. Sit amet commodo nulla facilisi. Pulvinar mattis nunc sed blandit libero volutpat. Vitae nunc sed velit dignissim. A pellentesque sit amet porttitor eget dolor morbi non arcu.
                                </P>
                            </div>
                            <div class="ml-2">
                                <div class="bg-gray-100 h-[20px] flex box-content p-2">
                                    <P weight="extrabold" size="sm">TOURNAMENT</P>
                                    <P color="text-green-500" class="ml-1" weight="extrabold" size="sm">FINISHED</P>
                                </div>
